...
public class Rs1 {
    ...
    @SerializedName("temp_bpmusergroupmapping_vessel.groupcode")
    @Expose
    private String groupcode;
    @SerializedName("temp_bpmusergroupmapping_vessel.usercode")
    @Expose
    private String usercode;
    @SerializedName("temp_bpmusergroupmapping_vessel.vslcompcode")
    @Expose
    private String vslcompcode;
    @SerializedName("temp_bpmusergroupmapping_vessel.roltype")
    @Expose
